...
public class ModificarReceta extends HttpServlet{
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response){
        try{
            ...
            String sql="update receta set IDReceta="+IDReceta+", Fecha_de_vencimiento='"+fechaDeVencimiento+"', IDTerapeuta="+IDTerapeuta+", IDPaciente="+IDPaciente;
            stat.executeUpdate(sql);

            sql = "delete from flor_receta where IDReceta="+IDReceta;
            stat.executeUpdate(sql);
